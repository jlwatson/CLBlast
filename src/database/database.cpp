...
Database::Database(const Device &device, const std::string &kernel_name,
  ...
  if (database.size() == 0) {
    database = std::vector<database::DatabaseEntry>{
        ...
        database::XgemmHalf, database::XgemmSingle, database::XgemmSingleInt, database::XgemmDouble, database::XgemmComplexSingle, database::XgemmComplexDouble,
        database::XgemmDirectHalf, database::XgemmDirectSingle, database::XgemmDirectSingleInt, database::XgemmDirectDouble, database::XgemmDirectComplexSingle, database::XgemmDirectComplexDouble,
